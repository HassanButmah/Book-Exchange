...
function isBookRelated(question) {
...
async function sendChatbotMessage() {
    ...
    // تحقق قبل إرسال السؤال إلى Gemma
    if (!isBookRelated(text)) {

        addMessage(
            "عذراً، أستطيع المساعدة فقط في الكتب والتبادل داخل المنصة.",
            "bot-msg"
        );
...
async function askGemma(message) {
